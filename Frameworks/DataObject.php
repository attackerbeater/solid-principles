...
class DataObject implements \ArrayAccess
{
	...
	{
		// pre-conditions 
		// checks if key exists from array key	
	    if ($key === (array)$key) {
	    	// post-condition
	    	// pass data to data array
	        $this->_data = $key;
	    } else {
	    	// // post-condition
	    	// create new index and value pass to data
...
// var_dump(method_exists($DataObject,'_getData'));
...
// $DataObject->toXml($DataObject->getData());


// echo "After: <br/>";
// $DataObject->unsetData($key = 'product_name');
// $DataObject->addData([
// 		'new_product_id' =>2
// 	]
// );
...
// var_dump(is_a(MyExtendingClass::class, MyBaseClass::class, true));
...
// // print_r($pages_array);
// $DataObject->toArray($pages_array);